...
interface IERC20 {
    ...
    // external은 복사를 하지 않는다. 내부에서 복사를 해서 메모리에 값을 사용하느냐 CALLDATA를 직접 읽어서 사용하느냐의 차이
    ...
    // {0x111111111111111111111111 : 100 , 0x11111111111111111111111 : 200}

    // {0x11111111111111111111111111 : {0x11111111111111111111111111 : 50}}
